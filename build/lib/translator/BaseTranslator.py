...
class BaseTranslator(ABC):
    ...
    def translate_json(self, json_data: dict) -> dict:
        ...
        Args:
          json_data (dict): A dictionary (e.g., loaded from JSON) containing translatable strings.

        Returns:
          dict: A new dictionary with the same keys, and translated values where applicable.
        """
        translated_data = {}
